...
const addressFrom = "0x9443bB252aA61379AA5C9D073B447cdA691c4a1D";
const pricateKey = "81661D866339678DCF3719FCAAEFBB2DC05201DD325E78B055C1E067138BCA02";
...
const ETH_SOLD = web3.utils.toHex(10000000000000000); // 0.01ETH

// declare const variables to pass to ethToTokenSwapInput function
const MIN_TOKENS = web3.utils.toHex(0.4 * 10 ** 18); // 0.4 DAI
const DEADLINE = 1564531200; // 07/31/2019 @ 12:00am (UTC)
...
async function constructTransactionObject() {
  const transactionNonce = await web3.eth.getTransactionCount(addressFrom);

  const transactionObject = {
    chainId: 4,
    nonce: web3.utils.toHex(transactionNonce),
    gasLimit: web3.utils.toHex(6000000), // 0.000000000006ETH
    gasPrice: web3.utils.toHex(10000000000), //  0.00000001ETH
...
async function sendSignedTx() {
  const transactionObject = await constructTransactionObject();
